...
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
 ...
 <section class="personal-info py-5">
            ...
            <div class="container">
                ...
                <input type="hidden" id="btype" name="btype" value="{{$_REQUEST['type']}}" /> 
                            ...
                            @apply_filters('cstudio.reservation.services')
                                ...
                                <div class="col-xxl-8 pe-xl-5 pt-4">
                                    <div class="personal-form row">
                                        ...
                                        <div class="col-xxl-10 pb-3">
                                            <label>
                                               @lang('theme::app.email'): 
                                            </label>
                                            <input type="text" class="border" id="customer_email" name="customer_email" value="" required >
                                        </div>
                                        ...
                                        <div class="col-xxl-10 pb-3">
                                            <label>@lang('theme::app.number_of_baby'):</label>
                                            <input type="text" class="border"  id="number_of_baby" name="number_of_baby">
                                        </div>
