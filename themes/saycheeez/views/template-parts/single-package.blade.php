                        ...
                        <div class="px-xxl-5">
                            <div class="row package-item">
                                <div class="col-sm-6 ps-xl-5 mb-sm-5 mb-5 d-block d-sm-none">
                                    ...
                                    @if($post->gallary_link)
                                    <a class="btn fs23  btn-gallery-m radius15 mh53 py-1 px-3 mb-5 d-inline-flex align-items-center" href="{{ $post->gallary_link}}" alt="{{ $post->getTitle() }}" >@lang('theme::app.gallery')</a>
                                    @endif
                                </div>
                                <div class="col-sm-8 pe-xl-5">
                                    <div class="package-head bg-light radius15 mh53 py-1 px-3 mb-3 d-inline-flex align-items-center">
                                        <h4 class="fs23">
                                            @lang('theme::app.packge_content'):
                                        </h4>
                                    </div>
                                ...
                                <div class="col-sm-4 ps-xl-5 mb-sm-5 mb-5 d-none d-sm-block">
                                    <img src="{{ $post->getThumbnail() }}" alt="{{ $post->getTitle() }}" class="w-100 mt-xl-0 mt-4">
                                     @if($post->gallary_link)
                                       <a class="btn fs23  btn-gallery radius15 mh53 py-1 px-3 mb-5 d-inline-flex align-items-center" href="{{ $post->gallary_link}}" alt="{{ $post->getTitle() }}" >@lang('theme::app.gallery')</a>
                                     @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="package-head bg-light radius15 mh53 py-1 px-3 mb-5 d-inline-flex align-items-center">
                                <h4 class="fs23">
                                    @lang('theme::app.Choose_Photo_type'):
                                </h4>
                            </div>
                        </div>
                         ...
                         <div class="col-xl-12">
                            ...
                            <div class="radius15 mh53 py-1 px-3 mb-5 d-inline-flex align-items-center">
                                @if($post->is_type==1)
                                <label for="ptype_normal" class="fs23 d-flex align-items-center">
                                    <input  style="margin:0px 10px; width: 20px; min-height: 20px;" id="ptype_normal" name="ptype" type="radio" value="normal" checked> @lang('theme::app.Normal_type')</label>
                                @endif
                                @if($post->is_type==2)
                                <label for="ptype_album" class="fs23 d-flex align-items-center">
                                    <input  style="margin:0px 10px; width: 20px; min-height: 20px;" id="ptype_album" name="ptype" type="radio" value="album">  @lang('theme::app.Album_type')</label>
                                 @endif   
                                 @if($post->is_type==3)
                                    <label for="ptype_normal" class="fs23 d-flex align-items-center">
                                    <input  style="margin:0px 10px; width: 20px; min-height: 20px;" id="ptype_normal" name="ptype" type="radio" value="normal" checked> @lang('theme::app.Normal_type')</label>
