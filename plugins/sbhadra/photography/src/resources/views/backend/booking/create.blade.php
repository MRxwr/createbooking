...
<script>
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="form-group row">
                 ...
                 <div class="form-group row">
                     <label for="" class="col-sm-5 col-md-4 col-form-label">Select type:</label>
                     <div class="col-sm-7 col-md-8">
                         <select class="form-control form-control-lg" name="type" onchange="packageTypeRedirect(this.value);" required>
                             <option value="normal">Single Print</option>
                             <option value="album">Album Picture</option>
                        </select>
                     </div>
    ...
    <div class="row">
            ...
            @do_action('admin.cstudio.themes')
                ...
                <input type="hidden" name="btype" id="btype" value="@if(isset($_REQUEST['type'])){{$_REQUEST['type']}}@endif">
                    <div class="col-12">
                    ...
                    @endif
                        ...
                        <div class="col-sm-7 col-md-8">
                            <input type="email" class="form-control form-control-lg" id="customer_email" name="customer_email" value="" required>
                        </div>
                        </div>
                        ...
                        <div class="form-group row">
                        <label for="" class="col-sm-5 col-md-4 col-form-label">Number of babies</label>
                            <div class="col-sm-7 col-md-8">
                                <input type="text" class="form-control form-control-lg" id="number_of_baby" name="number_of_baby">
                            </div>
                        </div>
                        <div class="form-group row">
